...
const ManageUser = () => {
   ...
   return (
      <Box m="20px">
               ...
               <tbody>
                  {users?.map((user) => (
                     ...
                     >
                        ...
                        <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                           <div className="flex items-center w-20 bg-green-600 px-1 py-2 rounded-md">
                              {user.role === "Admin" && (
                              ...
                              <Typography ml={1}>{user.role}</Typography>
                           </div>
                        </td>
         ...
         {user && (
            <div className=" overflow-y-auto overflow-x-hidden fixed flex top-0 right-0 left-0 z-[120] justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-black bg-opacity-50">
